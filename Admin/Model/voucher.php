<?php 
    class Voucher {
        ...
        public function insertVoucher($voucher_code, $voucher_name, $voucher_start, $voucher_end, $voucher_sale, $voucher_count, $voucher_status) {
            $db = new connect();
            $query = "insert into voucher (voucher_id, voucher_code, voucher_name, voucher_start, voucher_end, voucher_sale, voucher_count, voucher_status)
            values (Null, '$voucher_code', '$voucher_name', '$voucher_start', '$voucher_end', $voucher_sale, $voucher_count, $voucher_status)";
            $db->exec($query);
        }

        public function updateVoucher($voucher_id, $voucher_code, $voucher_name, $voucher_start, $voucher_end, $voucher_sale, $voucher_count, $voucher_status) {
            $db = new connect();
