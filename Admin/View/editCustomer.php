...
<div class="container mt-3">
    <a class="btn btn-info" href="index.php?action=customer">Hủy</a>
    ...
    <form>
        <div class="row">
            ...
            <div class="col-md-3 mt-4">
                <select class="" name="customer_render" value="<?php if (isset($customer_id)) echo $customer_render ?>">
            ...
            <div class="col-md-3">
                ...
                <input type="text" class="form-control" id="customer_phone" name="customer_phone" value="<?php if (isset($customer_id)) echo $customer_phone ?>">
            ...
            <div class="col-md-6">
                ...
                <input type="email" class="form-control" id="customer_email" name="customer_email" value="<?php if (isset($customer_id)) echo $customer_email ?>">
                <span id="customer_email_err" class="text-danger"></span>
            </div>
            <div class="col-md-6">
                <label for="phone" class="form-label">Password</label>
                <input type="text" class="form-control" id="customer_password" name="customer_password" value="<?php if (isset($customer_id)) echo $customer_password ?>">
            ...
            <div class="col-md-3">
                ...
                <select class="form-select" id="city-dropdown" name="customer_xa"></select>
            </div>
            <div class="col-md-3">
                <label for="" class="form-label">Địa chỉ nhà<span class="text-danger">*</span></label>
                <input type="text" class="form-control" name="customer_diachi" id="diachi">
            </div>
            ...
            <div class="col-md-12">
                ...
                <?php
                if ($act == 'insert') {
                    echo '<button id="submit_create" type="button" class="btn btn-primary">Thêm khách hàng</button>';
                } else if ($act == 'update') {
                    echo '<button id="submit_update" type="button" class="btn btn-primary">Cập nhật khách hàng</button>';
                }
                ?>
            </div>
        </div>
    ...
    $(document).ready(function() {
        ...
        function checkfirstname() {
            ...
            if ($('#customer_firstname').val().length < 2) {
                ...
                $('#customer_firstname_err').html('Họ và Tên đệm sai định dạng');
                return false;
            } else {
        ...
        function checklastname() {
            ...
            if ($('#customer_lastname').val().length < 2) {
                ...
                $('#customer_lastname_err').html('Tên sai định dạng');
                return false;
            } else {
