    ...
    <table class="table table-striped table-bordered table-hover my-3">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="index.php?action=menu&act=update&menu_id=<?php echo $set['menu_id'] ?>" class="btn btn-warning">Sửa</a>
                </td>
                <td>
                    <a href="index.php?action=menu&act=delete&menu_id=<?php echo $set['menu_id'] ?>" class="btn btn-danger">Xóa</a>
                </td>
            </tr>
            <?php
                endwhile;
